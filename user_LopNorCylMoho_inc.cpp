...
// LopNorCylinderMoho()
//
//   Adds sub-moho structure
//
//
void LopNorCylinderMoho(Grid & gr, const std::vector<Real> & args) {
  ...
  gr.WNode(0,0,3).SetAttributes(VpVs(6.80, 3.83), 3.10, Q_abv, HS_abv);
  gr.WNode(0,0,3).SetAttributes(VpVs(7.22, 4.01), 3.15, Q, HS);
  ...
  gr.WNode(0,0,4).SetAttributes(VpVs(7.22, 4.01), 3.15, Q, HS);
  gr.WNode(0,0,4).SetAttributes(VpVs(7.13, 3.96), 3.13, Q, HS);
  ...
  gr.WNode(0,0,5).SetAttributes(VpVs(7.13, 3.96), 3.13, Q, HS);
  gr.WNode(0,0,5).SetAttributes(VpVs(7.43, 4.11), 3.22, Q, HS);
  ...
  gr.WNode(0,0,6).SetAttributes(VpVs(7.43, 4.11), 3.22, Q, HS);
  gr.WNode(0,0,6).SetAttributes(VpVs(7.28, 4.00), 3.15, Q, HS);
  ...
  gr.WNode(0,0,7).SetAttributes(VpVs(7.28, 4.00), 3.22, Q_abv, HS_abv);
  gr.WNode(0,0,7).SetAttributes(VpVs(8.000, 4.460), 3.502, Q, HS);
  ...
  gr.WNode(0,0,8).SetAttributes(VpVs(8.000, 4.460), 3.502, Q, HS);
  gr.WNode(0,0,8).SetAttributes(VpVs(8.010, 4.465), 3.502, Q, HS);
  ...
  gr.WNode(0,0,9).SetAttributes(VpVs(8.010, 4.465), 3.502, Q, HS);
  gr.WNode(0,0,9).SetAttributes(VpVs(8.020, 4.470), 3.502, Q, HS);
  ...
  gr.WNode(0,0,10).SetAttributes(VpVs(8.020, 4.470), 3.502, Q, HS);
  gr.WNode(0,0,10).SetAttributes(VpVs(8.030, 4.475), 3.502, Q, HS);
  ...
  gr.WNode(0,0,11).SetAttributes(VpVs(8.030, 4.475), 3.502, Q_abv, HS_abv);
