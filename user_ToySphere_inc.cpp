...
void ToySphere(Grid & gr, const std::vector<Real> & args) {
  ...
  gr.WNode(0,0,2).SetAttributes( VpVs( 8.00, 4.40), 4.00, QMa, HSMa );
  gr.WNode(0,0,2).SetAttributes( VpVs( 8.50, 4.80), 4.20, QCo, HSCo );
  gr.WNode(0,0,3).SetAttributes( VpVs(10.00, 6.00), 4.90, QCo, HSCo );
